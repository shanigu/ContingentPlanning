...
namespace IMAP
{
    class SDRPlanner
    {
        ...
        public static TimeSpan PlannerTimeout = new TimeSpan(0, 0, 60);
        ...
        public void OfflinePlanning(string sPath, Domain domain, Problem problem)
        {
            ...
            Console.WriteLine(domain.Name + " done planning, time " + (dtEnd - dtStart).TotalSeconds + " , checking plan validity");
