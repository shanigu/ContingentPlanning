      ...
      // public static string BASE_PATH = @"D:\research\projects\PDDL";
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            Parser p = new Parser();
            Domain d = p.ParseDomain(@"D:\Research\projects\PDDL\CLG_benchmarks\localize7\d.pddl");
            Problem pr = p.ParseProblem(@"D:\Research\projects\PDDL\CLG_benchmarks\localize7\p.pddl", d);
            ...
            SDRPlanner sdr = new SDRPlanner(sBenchmarkPath, d, pr);
            sdr.OfflinePlanning(sBenchmarkPath, d, pr);
