...
namespace CPOR
{
    public class PartiallySpecifiedState
    {
        ...
        private bool ConsistentWith(Formula fOriginal, bool bCheckingActionPreconditions)
        {
            ...
            {
                if (fOriginal.IsTrue(pssCurrent.Observed))
                    return true;
                return false;
            }
        ...
        public void ApplyOffline(Action a, out Formula fObserve, out PartiallySpecifiedState psTrueState, out PartiallySpecifiedState psFalseState)
        {
            ...
            if (a.Observe != null)
            {
                ...
                {
                    HashSet<int> hsModifiedTrue = bsTrue.m_bsInitialBelief.ReviseInitialBelief(bsTrue.GeneratingObservation, bsTrue, out bool bConsistent);
                    if (bConsistent)
                    {
                ...
                {
                    HashSet<int> hsModifiedFalse = bsFalse.m_bsInitialBelief.ReviseInitialBelief(bsFalse.GeneratingObservation, bsFalse, out bool bConsistent);
                    if (bConsistent)
                    {
        ...
        private PartiallySpecifiedState Apply(Action aOrg, out Formula fObserve, bool bPropogateOnly)
        {
            ...
            if (!bPropogateOnly && a.Observe != null)
            {
                 ...
                 * */
                HashSet<int> hsModified = m_bsInitialBelief.ReviseInitialBelief(fObserve, this, out bool bConsistent);
...
*/
        ...
        public bool ExistsUncertainty()
        {
            foreach(CompoundFormula cf in m_bsInitialBelief.Hidden)
            {
                if (cf != null)
                    return true;
            }
