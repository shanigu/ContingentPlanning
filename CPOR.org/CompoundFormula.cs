...
namespace CPOR
{
    public class CompoundFormula : Formula
    {
        ...
        */
        ...
        public CompoundFormula RemoveConflictingEffects()
        {
            ...
            if (Operator == "and")
            {
                foreach (Formula fSub in Operands)
                {
                    ...
                    {
                        if (!Operands.Contains(fSub.Negate()))
                            cfNew.SimpleAddOperand(fSub);
                    }
                    else
                    {
                        cfNew.SimpleAddOperand(((CompoundFormula)fSub).RemoveConflictingEffects());
                    }
                }
            }
            ...
            {
                cfNew.SimpleAddOperand(Operands[0]);
                if (Operands[1] is PredicateFormula)
                {
                    cfNew.SimpleAddOperand(Operands[1]);
                }
                else
                {
                    cfNew.SimpleAddOperand(((CompoundFormula)Operands[1]).RemoveConflictingEffects());
                }
