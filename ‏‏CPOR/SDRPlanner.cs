...
namespace CPOR
{
    ...
    public class SDRPlanner
    {
        ...
        public enum Planners { FF, FFsa, FFha, MIPS, MetricFF, LPG, FD, CPT, FFX, FF_WSL, TRAPPER_WSL }
        public static Planners Planner = Planners.FF_WSL;
