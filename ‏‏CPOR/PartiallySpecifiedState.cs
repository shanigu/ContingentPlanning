            ...
            if (lOrg != null)
            {
                ...
                foreach (Formula daedend in lOrg)
                {
                    ...
                    if (daedend is PredicateFormula)
                    {
                        ...
                        if (pre_deadEnd == Domain.TRUE_PREDICATE)
                            Debug.Write("*");
...
*/
        ...
        */
        ...
        public State WriteTaggedDomainAndProblemDeadEnd(string sDomainFile, string sProblemFile, List<Formula> lMaybeDeadends, DeadendStrategy dsStrategy, bool bPreconditionFailure, out int cTags, out MemoryStream msModels)
        {
        ...
        private State WriteTaggedDomainAndProblemDeadEnd(string sDomainFile, string sProblemFile, List<Action> lActions, List<Formula> lMaybeDeadends, DeadendStrategy dsStrategy, bool bPreconditionFailure, out int cTags, out MemoryStream msModels)
        {
            PartiallySpecifiedState pssCurrent = this;
            while (pssCurrent.m_sPredecessor != null)
            {
