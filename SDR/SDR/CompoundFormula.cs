        ...
        */
        ...
        public override Formula Ground(Dictionary<string, Constant> dBindings)
        {
            ...
            foreach (Formula fSub in Operands)
            {
                ...
                cfGrounded.SimpleAddOperand(fGrounded);
            }
            return cfGrounded;
        }
        ...
        public CompoundFormula ToCNF()
        {
            ...
            Formula cfConverted = ToCNFRec();
            if (cfConverted is CompoundFormula)
                return (CompoundFormula)cfConverted;
            else
            {
                CompoundFormula cfAnd = new CompoundFormula("and");
                cfAnd.AddOperand(cfConverted);
                return cfAnd;
            }
        ...
        internal override Formula ToCNFRec()
        {
            if (Operator == "and")
            {
                if (IsSimpleFormula())
                ...
                CompoundFormula cfAnd = new CompoundFormula("and");
                foreach (Formula fSub in Operands)
                    cfAnd.AddOperand(fSub.ToCNFRec());
                return cfAnd;
