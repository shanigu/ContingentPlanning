...
namespace PDDL
{
    class MABlocksWorld2
    {
        ...
        public MABlocksWorld2(int cBlocks, int cArms, int cMaxStacksPerAgent)
        {
            ...
            AssignStacksToAgents();

            Stack<int>[] a = new Stack<int>[Arms * MaxStacksPerAgent];
        ...
        private void AssignStacksToAgents()
        {
            ...
            for (int i = 0; i < Arms - 1; i++)
            {
                ...
                bSmallAgent = dRand < 0.7;

                int cStacks = 0;
                if (bSmallAgent)
                    cStacks = RandomGenerator.Next(2) + 2;
                else
                    cStacks = RandomGenerator.Next(MaxStacksPerAgent / 2) + MaxStacksPerAgent / 2 + 2;
        ...
        private string GenerateProblem()
        {
            ...
            sProblem += "(problem MABlocksWorld2-" + Arms + "-" + Blocks + "-" + MaxStacksPerAgent + ")\n";
            sProblem += "(:domain MABlocksWorld2-" + Arms + "-" + Blocks + "-" + MaxStacksPerAgent + ")\n";
        ...
        private string GenerateDomain()
        {
            ...
            sDomain += "(domain MABlocksWorld2-" + Arms + "-" + Blocks + "-" + MaxStacksPerAgent + ")\n";
