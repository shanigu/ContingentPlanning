...
namespace PDDL
{
    class HSPHeuristic : HeuristicFunction
    {
        ...
        private void ComputeAllEffectsPreconditions()
        {
            ...
            HashSet<Action> lAllActions = m_dDomain.GroundAllActions();
        ...
        private double Delta(State s, List<Action> lPlan)
        {
            ...
            while (bChanged)
            {
                ...
                HashSet<Action> lActions = m_dDomain.GroundAllActions(lCurrentPredicates, true);
                bChanged = false;
        ...
        private double DeltaI(State s)
        {
            ...
            HashSet<Action> lActions = m_dDomain.GroundAllActions(lPredicates, true);
        ...
        */
        ...
        {
            Dictionary<State, Action> lStates = new Dictionary<State, Action>();
            HashSet<Action> lActions = m_dDomain.GroundAllActions(s.Predicates, false);
            foreach (Action a in lActions)
            {
