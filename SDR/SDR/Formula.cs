...
namespace PDDL
{
    ...
    {
        public int Size { get; protected set; } //size is the number of nodes in the syntax tree - "Some Exponential Lower Bounds on Formula-size in Modal Logic" Ditmarsch
        ...
        internal abstract Formula ToCNFRec();
    }
}
